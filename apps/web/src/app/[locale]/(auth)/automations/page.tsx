...
const TRIGGER_OPTIONS = [
  ...
  // Money events read off the payment row. Offered to every studio, including
  // one with no Stripe account connected: a trigger that never fires is inert, whereas
  // a hidden one is a support question from a studio mid-onboarding.
