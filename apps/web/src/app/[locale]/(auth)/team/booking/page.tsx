...
function BookingPreviewPanel({ teamName, accentColor }: { teamName: string; accentColor: string }) {
  return (
    <div className="min-h-[560px] rounded-2xl border overflow-hidden bg-background text-foreground font-sans">
      <div className="border-b bg-card px-5 py-3 text-sm font-medium text-muted-foreground">
        {teamName}
      </div>
