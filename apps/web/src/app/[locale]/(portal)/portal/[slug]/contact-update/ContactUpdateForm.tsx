  ...
  useEffect(() => {
    const resolve = async () => {
      try {
        ...
        if (snap.empty) { setStep('not-found'); return }
      ...
      <PortalShell teamName={teamName} slug={slug} accentColor={accentColor}>
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Verify your email to update your personal information with{' '}
    ...
    return (
      <PortalShell teamName={teamName} slug={slug} accentColor={accentColor}>
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Submit your updated information. Your manager will review and apply the
            changes.
          </p>
        </div>
        ...
        <div className="rounded-lg bg-blue-50 border border-blue-200 dark:bg-blue-950/20 dark:border-blue-800 px-4 py-3 text-sm text-blue-800 dark:text-blue-300">
          Your manager will compare the submitted data with what&apos;s currently on file
      ...
      <div className="space-y-6 text-center py-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Your manager at <strong>{teamName}</strong> will review your details and
            apply the update. You&apos;ll receive an email once it&apos;s been processed.
          </p>
        </div>
        <a
          href={`/portal/${slug}`}
