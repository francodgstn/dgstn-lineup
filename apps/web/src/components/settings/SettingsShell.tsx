...
// used by TWO layouts: (auth)/settings/layout.tsx, and the route-group layout at
// (auth)/public-page/(hub)/layout.tsx. "Public pages" is a settings section whose
// route is /public-page — bookmarked, and sibling to /public-page/shop and
// /public-page/space, so the path cannot move — and it was the one section that
// rendered as a bare full page instead of a settings panel (UX-61). Sharing the
// shell is what makes it look like the others without moving a route.
//
// Behaviour:
